...
public class ApplicationContextExtendsFindTest {
    ...
    public void findBeanByBeanType() {
    ...
    @Test
    @DisplayName("부모타임으로 모두조회하기 ")
    public void findBeanByParentName(){
    ...
    @Test
    @DisplayName("부모 타임으로 모두조회하기 - object")
    public void findBeanByObjectType(){
        // Spring 의 모든 Bean 다 출력됨 .
        // 자바객체는 Object 타입이기 때문
